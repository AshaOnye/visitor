    ...
    <div class="site-footer__top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp"
                    ...
                    <div
                        ...
                        <ul
                            ...
                            <li><a href="how_it_works.php">How it
                                    Works</a></li>
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp"
                    ...
                    <div
                        class="footer-widget__column footer-widget__non-profit clearfix">
                        <h3 class="footer-widget__title">Our Services
                        </h3>
                        <ul
                            class="footer-widget__non-profit-list list-unstyled clearfix">
                            <li><a href="">Air Freight</a></li>
                            <li><a href="">Sea Freight</a></li>
                            <li><a href="">Trucking</a></li>
                            <li><a href="">Storage and Warehousing</a>
                            </li>
                    ...
                    <div
                        ...
                        <ul
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <a
                                        href="mailto:info@cargomax.com">info@cargomax.com</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p>88 Broklyn Golden Street. New
                ...
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© Copyright
                            2022 by <a href="#">CargoMax Services
                                Limited</a>
                        </p>
